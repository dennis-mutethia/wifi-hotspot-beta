...
from utils.helper import to_dict
...
class API():
    ...
    def portal_data(self, hotspot_id: str):
        try:
    ...
    def subscribe(self, hotspot_id):        
        ...
        try:       
            ...
            stmt = insert(Subscribers).values(
                id=subscriber_id,
                phone=phone,
                user_id=self.get_next_user_id(session),
